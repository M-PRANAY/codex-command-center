...
- Shows live event updates and lets you stop dashboard-owned runs.
...
- Opens a local transcript for CLI sessions, including user prompts, Codex responses, and recorded tool activity.
...
- The dashboard can stop runs it started. It does not control another terminal's stdin, approvals, or terminal UI.
